...
func ConnectDatabaseWithRetry(ctx context.Context, cfg application.Config) (*pgxpool.Pool, error) {
...
func LoadConfig() application.Config {
	return application.Config{
		...
		AIMoveTimeMS:  domain.ClampMoveTime(getenvDefault("AI_MOVE_TIME_MS", "700"), 700),
		AISearchDepth: domain.ClampDepth(getenvDefault("AI_SEARCH_DEPTH", "8"), 8),
	}
}
